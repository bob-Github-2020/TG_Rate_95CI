...
## PSMSL fills the data gap as -99999
  ...
  # I wrote a Bash script, "do_PSMSL_Pre_Process.sh", for doing the pre-process. Get the source script in READEME.md!
...
for fin in os.listdir(directory):
    if fin.endswith(".rlrdata"):
       ...
       ts = ts_psmsl.iloc[:,1]
       # If you need process many TG datasets, may set pltshow='off'    
