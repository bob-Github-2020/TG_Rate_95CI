...
## The detailed methodology for calculating the 95%CI is adressed in:
   # Wang, G. (2023). The 95% confidence interval for the rate of monthly mean sea-level derived from tide gauge data, submitted xxx (02/03/2023)
...
## You may need to install several Python modules (e.g., pandas, statistics) on your computer if you have not installed before
  # do this by "pip install module-name"
    
## You need to install the LATEST Pyts Module for using the SSA module, carefully read the following website.
